...
export class GameEngine {
    ...
    */
    ...
    public drawBackground(opacity: number) {
        ...
        // One instance per background cell. The grid is world-aligned and covers the canvas with two
        // cells of slack, so its size follows the camera zoom rather than the canvas resolution.
