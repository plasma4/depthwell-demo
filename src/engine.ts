...
export class GameEngine {
    ...
    */
    ...
    public handleVisibleEntities() {
        ...
        // Each entity draw gets a disjoint range because all queue writes happen before submission.
        // The binding range lets the shader keep using instance_index from zero for each batch.
