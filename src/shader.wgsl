...
const LIGHT_HUE_DIR = array<vec2f, 64>(
    ...
    vec2f(0, 1),
    vec2f(0, 0.9951847266721969),
    vec2f(0, 0.9807852804032304),
    vec2f(0, 0.9569403357322089),
    vec2f(0, 0.9238795325112867),
    vec2f(0, 0.881921264348355),
    vec2f(0, 0.8314696123025453),
    vec2f(0, 0.7730104533627371),
    vec2f(0, 0.7071067811865476),
    vec2f(0, 0.6343932841636455),
    vec2f(0, 0.5555702330196022),
    vec2f(0, 0.47139673682599786),
    vec2f(0, 0.3826834323650899),
    vec2f(0, 0.2902846772544624),
    vec2f(0, 0.1950903220161286),
    vec2f(0, 0.09801714032956083),
    vec2f(0, 0),
    vec2f(0, 0),
    vec2f(0, 0),
    vec2f(0, 0),
    ...
    vec2f(0, 0),
    vec2f(0, 0),
    vec2f(0.09801714032956009, 0),
    vec2f(0.1950903220161283, 0),
    vec2f(0.29028467725446205, 0),
    vec2f(0.38268343236509, 0),
    vec2f(0.4713967368259976, 0),
    vec2f(0.5555702330196018, 0),
    vec2f(0.6343932841636456, 0),
    vec2f(0.7071067811865474, 0),
    vec2f(0.7730104533627365, 0),
    vec2f(0.8314696123025452, 0),
    vec2f(0.8819212643483548, 0),
    vec2f(0.9238795325112865, 0),
    vec2f(0.9569403357322088, 0),
    vec2f(0.9807852804032303, 0),
    vec2f(0.9951847266721969, 0),
);
// #CONSTANT REGION END#
