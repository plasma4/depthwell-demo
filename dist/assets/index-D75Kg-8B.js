(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function n(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(t){if(t.ep)return;t.ep=!0;const i=n(t);fetch(t.href,i)}})();const o={zoom:131072,drop:262144,minus:32768,plus:65536,up:2048,left:4096,down:8192,right:16384,k0:1,k1:2,k2:4,k3:8,k4:16,k5:32,k6:64,k7:128,k8:256,k9:512},w={player_pos:0,last_player_pos:16,player_chunk:32,player_velocity:48,camera_pos:64,last_camera_pos:80,camera_scale:96,camera_scale_change:104,depth:112,player_quadrant:120,player_screen_offset:128,keys_pressed_mask:136,keys_held_mask:140,seed:144},L="abcdefghijklmnopqrstuvwxyz",b=26n;function M(r=100){if(r<=0)return"";const e=new Uint8Array(72);crypto.getRandomValues(e);let n=0n;const s=new DataView(e.buffer);for(let a=0;a<e.length;a+=8)n=n<<64n|s.getBigUint64(a);let t="",i=n%b**BigInt(r);for(;i>=0n&&(t+=L[Number(i%b)],i=i/b-1n,!(i<0n)););return t}function z(r){let e=0n;for(let n=0;n<r.length;n++){const s=BigInt(r.charCodeAt(n)-97);e=e*b+(s+1n)}return e}async function F(r,e){const n=z(r),s=new DataView(new ArrayBuffer(64));for(let c=0;c<8;c++)s.setBigUint64(c*8,n>>BigInt((7-c)*64)&0xffffffffffffffffn);let t=new Uint8Array(s.buffer,0,32),i=new Uint8Array(s.buffer,32,32);const a=await Promise.all([0,1,2,3].map(c=>crypto.subtle.importKey("raw",new Uint8Array([c]),{name:"HMAC",hash:"SHA-256"},!1,["sign"])));for(const c of a){const _=new Uint8Array(await crypto.subtle.sign("HMAC",c,i)),u=new Uint8Array(32);for(let h=0;h<32;h++)u[h]=t[h]^_[h];t=i,i=u}const d=new Uint8Array(64);return d.set(t,0),d.set(i,32),e.set(new BigUint64Array(d.buffer)),e}const T={Minus:o.minus,Equal:o.plus,KeyZ:o.zoom,KeyQ:o.drop,ArrowUp:o.up,KeyW:o.up,ArrowLeft:o.left,KeyA:o.left,ArrowDown:o.down,KeyS:o.down,ArrowRight:o.right,KeyD:o.right,Digit0:o.k0,Digit1:o.k1,Digit2:o.k2,Digit3:o.k3,Digit4:o.k4,Digit5:o.k5,Digit6:o.k6,Digit7:o.k7,Digit8:o.k8,Digit9:o.k9};function q(){let r={};const e={heldMask:0,keysHeld:0,keysPressed:0,currentlyHeld:0,horizontalPriority:0,verticalPriority:0,plusMinusPriority:0};function n(){r={},e.horizontalPriority=0,e.verticalPriority=0,e.plusMinusPriority=0,e.currentlyHeld=0,e.heldMask=0,e.keysPressed=0}return window.addEventListener("keydown",s=>{if(s.repeat)return;const t=T[s.code];t&&(e.heldMask|=t,r[t]=(r[t]||0)+1,t&(o.left|o.right)&&(e.horizontalPriority=t),t&(o.up|o.down)&&(e.verticalPriority=t),t&(o.plus|o.minus)&&(e.plusMinusPriority=t))}),window.addEventListener("keyup",s=>{const t=T[s.code];t&&(r[t]=Math.max(0,(r[t]||0)-1),r[t]===0&&(e.heldMask&=~t,t===e.horizontalPriority&&(e.horizontalPriority=e.heldMask&o.left||e.heldMask&o.right||0),t===e.verticalPriority&&(e.verticalPriority=e.heldMask&o.up||e.heldMask&o.down||0),t===e.plusMinusPriority&&(e.plusMinusPriority=e.heldMask&o.plus||e.heldMask&o.minus||0)))}),window.addEventListener("blur",n),document.addEventListener("visibilitychange",n),window.addEventListener("contextmenu",n),e}function V(r){const e=o.up|o.down|o.left|o.right;let n=r.heldMask&~e;n|=r.horizontalPriority,n|=r.verticalPriority,n|=r.plusMinusPriority,r.keysPressed=n&~r.keysHeld,r.currentlyHeld=n,r.keysHeld=n}const N=""+new URL("main-B97hsS3h.wasm",import.meta.url).href,C=`/*
