...
/// (So, 4 times means that the world will get 4 times wider and taller during depth ascend.)
...
///
/// This is an important value for ancestry and depth ascend calculations.
