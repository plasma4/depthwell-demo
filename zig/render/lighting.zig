...
//!
//! Light is divided in to three fixed hues.
//! These hues are equal distances apart on the OKLAB hue circle.
...
pub const LIGHT_CHROMA_MAX: f32 = 0.12;
...
fn blockEmission(id: Sprite) Emission {
    return switch (id) {
        ...
        .aquashard => .{ .strength = 100, .color = .{ .hue = Hue.cyan, .chroma = 0.55 } },
...
/// This data structure is faster than a standard Dial bucket sweep.
