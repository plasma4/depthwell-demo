...
inline fn hasSlot(s: Sprite) bool {
    ...
    // The right half of a 2x1 pair is placed BY its left half, never chosen; showing it would offer a
    // block that deletes itself the moment it lands (see `world.modifyBlockType()`).
