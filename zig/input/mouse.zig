...
/// The categories stop cross-activation, such as a pointerdown in the inventory
/// and a pointerup on an indicator.
...
/// Without this pass, a first-frame click goes to whichever of the render and
/// the logical tick runs first.
...
/// Handles mouse logic.
/// `x` and `y` are 0-1, a UV over the whole canvas, and come from the HTML host.
...
/// - Action 5 (INVALIDATE) : N/A, a blur or a resize happened
