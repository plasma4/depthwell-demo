...
/// `wx` and `wy` name the child cell in one coherent field, so adjacent cells form patches.
inline fn infillsCorner(noise_seed: dw.utils.Vec2u, wx: WorldCoord, wy: WorldCoord) bool {
    ...
    return field <= INFILL_CORNER_CHANCE;
}
...
test "infill: coherent field is deterministic and varied" {
