...
pub const AncestorCache = struct {
    ...
    pub fn clear(self: *@This()) void {
        // @memset per tier rather than one whole-array `= @splat(...)`: assigning an array this size
        // builds the value in the stack frame first, which in Debug is most of the frame.
        for (0..HOT_TIERS) |i| {
...
/// Whether a child cell is one the carve may never take: the parent's core,
/// plus an arm reaching the region border toward each SOLID orthogonal neighbor.
///
