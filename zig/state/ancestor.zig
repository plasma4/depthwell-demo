...
pub fn applyAncestorLogic(
    ...
    // Everything one child cell needs to be answered, built once: the plan below refines from it, and
    // every evolution on the way down rolls its odds against it (see `refine.evolve()`).
