...
/// A coherent field groups nearby corners, so pockets and one-parent-wide tunnels stop being fixed 4x4 shapes.
const INFILL_CORNER_CHANCE = 0.90;
/// Width of the coherent infill field in child blocks.
/// It spans several parent regions, so adjacent eligible corners form patches rather than static.
