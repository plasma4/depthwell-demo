...
fn carvesSlope(
    ...
    if (isProtectedCell(lx, ly)) return false;
...
///
/// The function never creates a solid child from an empty parent.
pub fn applyAncestorLogic(
    ...
    // Step 1. Empty parents always stay empty.
