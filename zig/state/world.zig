...
pub const SimBuffer = struct {
    ...
    /// Background caching/streaming logic: scans the boundary immediately outside the 16x16 chunk in the direction of movement;
    /// creates it in `chunk_cache` before the player reaches it.
    ///
