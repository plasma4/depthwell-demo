...
/// That is what lets `replayRebaseState()` rebuild a depth's seeds from the recorded origin path.
...
/// where it reads back as a copy of cell 0 and hides the edge of the world.
