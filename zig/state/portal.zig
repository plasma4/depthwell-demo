...
/// toward the mouth's violet without flattening every material to one color.
...
/// LCHA colors for the intake particles: the portal's violets and magentas, plus its gold trim.
...
fn spawnSwallow() void {
    ...
    dw.particles.spawnBurst(center, &PORTAL_COLORS, .{
    ...
    dw.particles.spawnOrbitRing(center, &PORTAL_COLORS, .{
...
fn spawnIntake() void {
    ...
    if (cap > 2) {
        dw.particles.spawnOrbitRing(worldToScreen(effect_center), &PORTAL_COLORS, .{
            .count = count,
