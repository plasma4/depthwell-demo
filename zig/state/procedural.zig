...
const ORE_DISPERSALS = [_]OreDispersal{
    .{ .sprite = .copper, .min_depth_offset = 0, .scale = 8, .octaves = 3, .hybrid_weight = 0.20, .warp_strength = 0.80, .threshold = 0.68, .min_density = 0.42, .max_density = 0.70, .seed_lane = 0 },
    .{ .sprite = .iron, .min_depth_offset = 0, .scale = 10, .octaves = 3, .hybrid_weight = 0.35, .warp_strength = 0.75, .threshold = 0.70, .min_density = 0.40, .max_density = 0.68, .seed_lane = 1 },
    .{ .sprite = .silver, .min_depth_offset = 0, .scale = 12, .octaves = 4, .hybrid_weight = 0.25, .warp_strength = 0.65, .threshold = 0.70, .min_density = 0.30, .max_density = 0.56, .seed_lane = 2 },
    .{ .sprite = .quartz, .min_depth_offset = 0, .scale = 9, .octaves = 3, .hybrid_weight = 0.45, .warp_strength = 0.70, .threshold = 0.70, .min_density = 0.30, .max_density = 0.58, .seed_lane = 3 },
    .{ .sprite = .gold, .min_depth_offset = 1, .scale = 11, .octaves = 4, .hybrid_weight = 0.30, .warp_strength = 0.65, .threshold = 0.70, .min_density = 0.48, .max_density = 0.82, .seed_lane = 0 },
    .{ .sprite = .nickel, .min_depth_offset = 1, .scale = 8, .octaves = 3, .hybrid_weight = 0.55, .warp_strength = 0.80, .threshold = 0.71, .min_density = 0.40, .max_density = 0.72, .seed_lane = 1 },
    .{ .sprite = .sapphire, .min_depth_offset = 1, .scale = 13, .octaves = 4, .hybrid_weight = 0.40, .warp_strength = 0.60, .threshold = 0.72, .min_density = 0.30, .max_density = 0.56, .seed_lane = 4 },
    .{ .sprite = .emerald, .min_depth_offset = 1, .scale = 10, .octaves = 3, .hybrid_weight = 0.50, .warp_strength = 0.70, .threshold = 0.72, .min_density = 0.34, .max_density = 0.62, .seed_lane = 3 },
    .{ .sprite = .cobalt, .min_depth_offset = 2, .scale = 14, .octaves = 4, .hybrid_weight = 0.30, .warp_strength = 0.55, .threshold = 0.73, .min_density = 0.52, .max_density = 0.90, .seed_lane = 2 },
    .{ .sprite = .ruby, .min_depth_offset = 2, .scale = 11, .octaves = 4, .hybrid_weight = 0.60, .warp_strength = 0.65, .threshold = 0.74, .min_density = 0.26, .max_density = 0.54, .seed_lane = 4 },
    .{ .sprite = .aquashard, .min_depth_offset = 2, .scale = 16, .octaves = 4, .hybrid_weight = 0.45, .warp_strength = 0.50, .threshold = 0.74, .min_density = 0.20, .max_density = 0.48, .seed_lane = 2 },
    .{ .sprite = .amethyst, .min_depth_offset = 0, .scale = 10, .octaves = 4, .hybrid_weight = 0.65, .warp_strength = 0.60, .threshold = 0.75, .min_density = 0.28, .max_density = 0.55, .seed_lane = 3 },
    .{ .sprite = .electrit, .min_depth_offset = 3, .scale = 18, .octaves = 4, .hybrid_weight = 0.70, .warp_strength = 0.45, .threshold = 0.77, .min_density = 0.24, .max_density = 0.52, .seed_lane = 4 },
};
...
comptime {
    for (ORE_DISPERSALS) |rule| {
        ...
        if (rule.warp_strength < 0 or rule.warp_strength > 1) @compileError("Ore warp strengths must be normalized.");
    }
}
...
fn oreField(seed: Vec2u, x: u64, y: u64, rule: OreDispersal) f32 {
    // Warp the sample domain with a separate, broad field. This breaks the square/diagonal grain
    // of sampling the same axis-aligned lattice at every octave without making deposits diffuse.
    const warp = getDualValueNoise(seed, x, y, 1.0 / (rule.scale * 2.5));
    const warp_x: i64 = @intFromFloat((warp[0] - 0.5) * rule.scale * rule.warp_strength);
    const warp_y: i64 = @intFromFloat((warp[1] - 0.5) * rule.scale * rule.warp_strength);
    ...
    inline for (0..4) |octave| {
        ...
        const n = getDualValueNoise(seed, sample_x *% frequency +% octave *% 7919, sample_y *% frequency +% octave *% 104729, 1.0 / rule.scale)[octave & 1];
