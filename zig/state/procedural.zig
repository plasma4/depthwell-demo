...
const ORE_DISPERSALS = [_]OreDispersal{
    .{ .sprite = .copper, .min_depth_offset = 0, .scale = 24, .octaves = 3, .hybrid_weight = 0.20, .threshold = 0.68, .min_density = 0.42, .max_density = 0.70, .seed_lane = 0 },
    .{ .sprite = .iron, .min_depth_offset = 0, .scale = 31, .octaves = 3, .hybrid_weight = 0.35, .threshold = 0.70, .min_density = 0.40, .max_density = 0.68, .seed_lane = 1 },
    .{ .sprite = .silver, .min_depth_offset = 0, .scale = 39, .octaves = 4, .hybrid_weight = 0.25, .threshold = 0.70, .min_density = 0.30, .max_density = 0.56, .seed_lane = 2 },
    .{ .sprite = .quartz, .min_depth_offset = 0, .scale = 28, .octaves = 3, .hybrid_weight = 0.45, .threshold = 0.70, .min_density = 0.30, .max_density = 0.58, .seed_lane = 3 },
    .{ .sprite = .gold, .min_depth_offset = 1, .scale = 43, .octaves = 4, .hybrid_weight = 0.30, .threshold = 0.70, .min_density = 0.48, .max_density = 0.82, .seed_lane = 0 },
    .{ .sprite = .nickel, .min_depth_offset = 1, .scale = 22, .octaves = 3, .hybrid_weight = 0.55, .threshold = 0.71, .min_density = 0.40, .max_density = 0.72, .seed_lane = 1 },
    .{ .sprite = .sapphire, .min_depth_offset = 1, .scale = 51, .octaves = 4, .hybrid_weight = 0.40, .threshold = 0.72, .min_density = 0.30, .max_density = 0.56, .seed_lane = 4 },
    .{ .sprite = .emerald, .min_depth_offset = 1, .scale = 34, .octaves = 3, .hybrid_weight = 0.50, .threshold = 0.72, .min_density = 0.34, .max_density = 0.62, .seed_lane = 3 },
    .{ .sprite = .cobalt, .min_depth_offset = 2, .scale = 57, .octaves = 4, .hybrid_weight = 0.30, .threshold = 0.73, .min_density = 0.52, .max_density = 0.90, .seed_lane = 2 },
    .{ .sprite = .ruby, .min_depth_offset = 2, .scale = 46, .octaves = 4, .hybrid_weight = 0.60, .threshold = 0.74, .min_density = 0.26, .max_density = 0.54, .seed_lane = 4 },
    .{ .sprite = .aquashard, .min_depth_offset = 2, .scale = 63, .octaves = 4, .hybrid_weight = 0.45, .threshold = 0.74, .min_density = 0.20, .max_density = 0.48, .seed_lane = 2 },
    .{ .sprite = .amethyst, .min_depth_offset = 0, .scale = 36, .octaves = 4, .hybrid_weight = 0.65, .threshold = 0.75, .min_density = 0.28, .max_density = 0.55, .seed_lane = 3 },
    .{ .sprite = .electrit, .min_depth_offset = 3, .scale = 72, .octaves = 4, .hybrid_weight = 0.70, .threshold = 0.77, .min_density = 0.24, .max_density = 0.52, .seed_lane = 4 },
};
