...
pub const Rule = struct {
    ...
    fn stack(self: Rule) ?[]const Sprite {
...
pub fn canEvolveInto(sprite: Sprite, n: [8]Block, ly: u4) bool {
...
fn surfaceMet(rule: Rule, ctx: Context) bool {
    return switch (rule.surface) {
...
fn drawCount(h: u64, copies: Count) u4 {
...
fn spec(id: Sprite, ctx: Context, tag: RefinedTag) BlockSpec {
    return .{
        .id = id,
        .seed = ctx.seed,
