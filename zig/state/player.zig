...
/// Lightness band a puff picks from.
/// Near white, so the dust reads as lit air and not as a material.
...
/// Smallest and largest landing burst, in particles.
/// The fall speed picks between them.
...
/// At 60 FPS this is the same code path it always was.
...
/// A corner that entered a solid cannot clear its far side without a further whole block of travel,
/// and the sweep is at most one block.
