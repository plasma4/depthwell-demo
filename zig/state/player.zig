...
/// A portal descent freezes movement for its whole length, so without this the coyote window from
/// before the descent survives it and grants a free jump on the far side.
