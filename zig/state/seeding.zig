...
///
/// The width is load-bearing, NOT a convenience: a narrower coordinate makes the noise field cycle
/// somewhere inside the world. Nothing on the hot path performs a 128-bit multiply because of it,
/// though; see `latticeAxis()` for how the placement stays inside 64-bit arithmetic.
