...
pub const INVENTORY_START = GEAR_ID + 36;
...
comptime {
    if (max_sprite_value != 266) @compileError("Max sprite value unexpected!");
}
...
pub const Sprite = enum(u16) {
    ...
    spiral_plant2 = GEAR_ID + 5,
    ceiling_flower = GEAR_ID + 6, // 2 variations
    mushroom = GEAR_ID + 8, // 3 variations
    big_mushroom = GEAR_ID + 11, // 3 variations
    forest_furnace = GEAR_ID + 14,
    lava_furnace,
    basic_core = GEAR_ID + 16,
    core1 = GEAR_ID + 18,
    core2 = GEAR_ID + 20,
    core3 = GEAR_ID + 22,
    core4 = GEAR_ID + 24,
    campfire = GEAR_ID + 26, // 4 variations + 4 water variations, 8 total
    campfire_water = GEAR_ID + 26 + 4,
    chest = GEAR_ID + 26 + 8,
