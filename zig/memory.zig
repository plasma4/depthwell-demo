...
pub const Block = packed struct(u128) {
    ...
    /// Generation writes it for air as well as for terrain.
    /// A replayed player edit leaves it alone.
    /// So a cell's variant survives a save, a cache eviction, and being built into.
    seed: u28,
