...
pub const GameState = extern struct {
    ...
    ///
    /// New fields belong at the END of `GameState`: `src/enums.ts` carries generated byte offsets for `seed`
...
/// Six bits each for L, C, and H channels!
...
pub const Block = packed struct(u128) {
    ...
    ///
    /// Derived, like the flag fields: regeneration rebuilds it, `ModCell` does not store it,
