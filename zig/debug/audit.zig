...
//!
//! `target_chance` is a roll, not a density: terrain rules throw most rolls away and how many is unknowable at compile-time,
//! so the only real way to tune a structure is to place a lot of world and count.
//! This does that, over a region around the player, and reports what actually landed.
//!
