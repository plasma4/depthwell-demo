...
NOTE: you can change whether diffs are visually shown through `.vscode/settings.json` (ideal with Git-only version control). Use `git symbolic-ref HEAD refs/heads/main` to go back to main when using Jujitsu.
